...
There is no need for apply a initial seed to the database. The `db.sqlite3` file is shipped within the repository, and has all the necessary data for a initial test.
